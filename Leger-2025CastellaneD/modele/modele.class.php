...
/**************** Gestion des candidats ************/
    ...
    public function selectAllCandidats($filtre = "") {
        if ($filtre == "") {
            ...
            $requete = "SELECT * FROM candidat WHERE NOM LIKE :filtre OR PRENOM LIKE :filtre OR AGE LIKE :filtre OR EMAIL LIKE :filtre OR MDP :filtre OR NUMERO_TELEPHONE LIKE :filtre;";
...
/**************** Gestion des plannings ************/
    ...
    public function selectAllPlannings($filtre = "") {
        if ($filtre == "") {
            ...
            $requete = "SELECT * FROM plannings WHERE IDlecon LIKE :filtre OR IDcandidat LIKE :filtre OR DATEHEURDEBUT LIKE :filtre OR IDmoniteur LIKE :filtre OR ETAT LIKE :filtre;";
            $donnees = array(":filtre" => "%" . $filtre . "%");
            $exec = $this->unPdo->prepare($requete);
            $exec->execute($donnees);
        }
