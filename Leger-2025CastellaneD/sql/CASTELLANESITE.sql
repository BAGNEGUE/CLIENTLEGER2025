...
CREATE TABLE candidat (
  ...
  type_user enum('CANDIDAT') DEFAULT 'CANDIDAT',
...
CREATE TABLE responsable (
  idresponsable int(2) NOT NULL auto_increment,
  nom varchar(32) NULL,
  prenom varchar(32) NULL,
  email varchar(32) NULL,
  mdp varchar(255) NULL,
  type_user enum('RESPONSABLE') DEFAULT 'RESPONSABLE',
  numero_telephone varchar(32) NULL,
...
CREATE TABLE moniteur (
  ...
  email varchar(32) NULL,
  mdp varchar(255) NULL,
  type_user enum('MONITEUR') DEFAULT 'MONITEUR',
  numero_telephone varchar(32) NULL,
...
-- Mise à jour des mots de passe existants avec des hashs
UPDATE user SET mdp = '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi' WHERE email = 'a@gmail.com';
UPDATE user SET mdp = '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi' WHERE email = 'b@gmail.com';

-- Pour la table candidat
UPDATE candidat SET mdp = '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi' WHERE mdp IS NOT NULL;

-- Pour la table moniteur
UPDATE moniteur SET mdp = '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi' WHERE mdp IS NOT NULL;

-- Pour la table responsable
UPDATE responsable SET mdp = '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi' WHERE mdp IS NOT NULL;

-- Note: Le hash utilisé correspond au mot de passe "password"
-- Les utilisateurs devront réinitialiser leur mot de passe lors de leur première connexion
